...
/**
 * Represents an Animated Pumpkin monster in the game.
 *
 * @author Jakob Cederblad
 */
public class MonsterAnimatedPumpkin extends Monster {
    /** Base name for monster */
    public final static String BASE_NAME = "Animated Pumpkin";
    /** Base health for monster */
    public final static int BASE_HEALTH = 100;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-animated-pumpkin.png";
    /** base gold yield when killing monster */
    public final static int BASE_GOLD_YIELD = 50;
    ...
    /**
     * Create a new instance of an Animated Pumpkin monster
     */
    public MonsterAnimatedPumpkin() {
