...
/**
 * Represents a Frog monster in the game.
 *
 * @author Jakob Cederblad
 */
public class MonsterFrog extends Monster {
    /** Base name for monster */
    public final static String BASE_NAME = "Frog";
    /** Base health for monster */
    public final static int BASE_HEALTH = 10;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-frog.png";
    /** base gold yield when killing monster */
    public final static int BASE_GOLD_YIELD = 5;
    ...
    /**
     * Create a new instance of a Frog monster
     */
    public MonsterFrog() {
