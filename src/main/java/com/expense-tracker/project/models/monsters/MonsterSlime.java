...
public class MonsterSlime extends Monster {
    ...
    public final static String BASE_NAME = "Slime";
    /** Base health for monster */
    public final static int BASE_HEALTH = 175;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-slime.png";
    /** base gold yield when killing monster */
    public final static int BASE_GOLD_YIELD = 75;
    ...
    /**
     * Create a new instance of a Slime monster
     */
    public MonsterSlime() {
