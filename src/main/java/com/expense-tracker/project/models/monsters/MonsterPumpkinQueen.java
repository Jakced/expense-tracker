...
/**
 * Represents a Pumpkin Queen monster in the game.
 *
 * @author Jakob Cederblad
 */
public class MonsterPumpkinQueen extends Monster {
    /** Base name for monster */
    public final static String BASE_NAME = "Pumpkin Queen";
    /** Base health for monster */
    public final static int BASE_HEALTH = 2500;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-pumpkin-queen.png";
    /** base gold yield when killing monster */
    public final static int BASE_GOLD_YIELD = 3500;

    /**
     * Create a new instance of a Pumpkin Queen monster
     */
    public MonsterPumpkinQueen() {
