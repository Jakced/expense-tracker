...
/**
 * Represents a Rat monster in the game.
 *
 * @author Jakob Cederblad
 */
public class MonsterRat extends Monster {
    /** Base name for monster */
    public final static String BASE_NAME = "Rat";
    /** Base health for monster */
    public final static int BASE_HEALTH = 5;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-rat.png";
    ...
    /**
     * Create a new instance of a Rat monster
     */
    public MonsterRat() {
