...
/**
 * Represents a Mushroom Plant monster in the game.
 *
 * @author Jakob Cederblad
 */
public class MonsterMushroomPlant extends Monster {
    /** Base name for monster */
    public final static String BASE_NAME = "Mushroom Plant";
    /** Base health for monster */
    public final static int BASE_HEALTH = 400;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-mushroom-plant.png";
    /** base gold yield when killing monster */
    public final static int BASE_GOLD_YIELD = 600;
    ...
    /**
     * Create a new instance of a Mushroom Plant monster
     */
    public MonsterMushroomPlant() {
