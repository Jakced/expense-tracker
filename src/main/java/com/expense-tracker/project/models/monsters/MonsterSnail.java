...
/**
 * Represents a Snail monster in the game.
 *
 * @author Jakob Cederblad
 */
public class MonsterSnail extends Monster {
    /** Base name for monster */
    public final static String BASE_NAME = "Snail";
    /** Base health for monster */
    public final static int BASE_HEALTH = 300;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-snail.png";
    ...
    /**
     * Create a new instance of a Snail monster
     */
    public MonsterSnail() {
