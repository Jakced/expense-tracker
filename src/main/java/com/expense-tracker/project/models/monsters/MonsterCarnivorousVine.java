...
/**
 * Represents a Carnivorous Vine monster in the game.
 *
 * @author Jakob Cederblad
 */
public class MonsterCarnivorousVine extends Monster {
    /** Base name for monster */
    public final static String BASE_NAME = "Carnivorous Vine";
    /** Base health for monster */
    public final static int BASE_HEALTH = 150;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-carnivorous-vine.png";
    /** base gold yield when killing monster */
    public final static int BASE_GOLD_YIELD = 100;
    ...
    /**
     * Create a new instance of a Carnivorous Vine monster
     */
