...
/**
 * Represents a Mushroom Creeper monster in the game.
 *
 * @author Jakob Cederblad
 */
public class MonsterMushroomCreeper extends Monster {
    /** Base name for monster */
    public final static String BASE_NAME = "Mushroom Creeper";
    /** Base health for monster */
    public final static int BASE_HEALTH = 200;
    /** Image icon path for monster */
    public final static String ICON_PATH = "src/main/resources/monster-mushroom-creeper.png";
    ...
    /**
     * Create a new instance of a Mushroom Creeper monster
     */
    public MonsterMushroomCreeper() {
